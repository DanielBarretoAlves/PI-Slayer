...
public class UsuarioC {
    ...
    public boolean lerArquivoCSV(UsuarioC listaDE, File _arquivo){
        
        // Objeto BufferedReader exige try-catch
        try {
            
            // Local onde o arquivo está
            this.arquivo = _arquivo.getAbsolutePath();
            ...
            while((this.linha = this.bReader.readLine())!= null){
                ...
                // Caso o arquivo contenha aspas duplas para os campos,
                // deve-se substituí-las por vazio.
                //this.linha = this.linha.replaceAll("\"","");
